...
theme.bg_focus      = "#c1ff66"
theme.bg_normal     = "#5760a0"
theme.bg_urgent     = "#fce94f"
theme.bg_minimize   = "#222640"
theme.bg_systray    = theme.bg_normal

theme.fg_normal     = "#2d1214"
theme.fg_focus      = "#2d1214"
theme.fg_urgent     = "#2d1214"
theme.fg_minimize   = "#2d1214"

theme.useless_gap   = dpi(0)
theme.border_width  = dpi(2)
theme.border_normal = "#dae3e0"
theme.border_focus  = "#122d1e"
